...
const renderComponent = (parent, HTML) => {
...
const renderMockComponents = () => {
  ...
  renderComponent(boardFilterContainer, makeBoardFilterTemplate());
  renderComponent(boardTasksContainer, makeCardEditTemplate());

  for (let i = 1; i <= CARDS_COUNT; i++) {
    renderComponent(boardTasksContainer, makeCardTemplate());
  }

  renderComponent(boardContainer, makeLoadMoreTemplate());
};
